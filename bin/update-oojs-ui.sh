...
OOJSUI_VERSION=$(nodejs -e 'console.log(require("./node_modules/oojs-ui/package.json").version);')
if [ "$OOJSUI_VERSION" == "" ]
then
...
rsync --force --recursive --delete ./node_modules/oojs-ui/dist/ "$REPO_DIR/$TARGET_DIR" || exit 1
